...
array, no;
other;
text: [{ "address": "123 Main St, Birmingham AL 35206", "saleDate": "2025-06-01", "salePrice": 185000, "sqft": 1450, "beds": 3, "baths": 2, "renovationEvidence": "updated kitchen, new roof", "subdivisionProof": "MLS shows East Lake subdivision", "sourcePortal": "Redfin", "sourceUrl": "https://redfin.com/..." }];
If;
fewer;
than;
2;
...
$$;
{
    arvNumbers.low?.toLocaleString();
}
/ Median $${arvNumbers.median?.toLocaleString()} /;
High;
$$;
{
    arvNumbers.high?.toLocaleString();
}
Return;
JSON;
only: {
