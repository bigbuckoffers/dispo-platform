...
const matching_processor_1 = require("./matching.processor");
...
exports.MatchingModule = MatchingModule = __decorate([
    (0, common_1.Module)({
        imports: [
            bull_1.BullModule.registerQueue({ name: 'matching' }),
            ai_module_1.AiModule,
        ],
        controllers: [matching_controller_1.MatchingController],
        providers: [matching_service_1.MatchingService, matching_processor_1.MatchingProcessor],
