...
export declare class IntakeService {
    ...
    approveSubmission(submissionId: string, approvedFields: any): Promise<{
        success: boolean;
    }>;
    rejectSubmission(submissionId: string): Promise<{
        success: boolean;
    }>;
    generateBulkTokens(orgId: string): Promise<{
        buyerId: string;
        token: string;
        phone: string;
    }[]>;
    trackEvent(token: string, event: string, metadata?: any): Promise<{
        ok: boolean;
        error?: undefined;
    } | {
        ok: boolean;
